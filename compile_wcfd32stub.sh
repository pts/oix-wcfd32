...
rm -f wcfd32stub oixrun wcfd32load.inc.nasm
cp -a run1/wcfd32stub run1/oixrun run1/wcfd32load.inc.nasm ./
...
"$nasm" -O999999999 -w+orphan-labels -f bin -o oixrun.oix oixrun.nasm  # %include: wcfd32load.inc.nasm
