;
; elf2oix_mode2.nasm: build 0x18-byte setup code an OIX program which has do relocations and its entry point is at the beginning
; by pts@fazekas.hu at Tue Jul  8 17:10:45 CEST 2025
;
; Compile with: nasm-0.98.39 -O0 -w+orphan-labels -f bin -o elf2oix_mode2.bin elf2oix_mode2.nasm
