...
.end:
oixruns_image:	incbin 'oixruns.oix', 0x18  ;  !! Don't include it twice, merge it to oixrun.oix.
...
DumpEnvironment:
		push ebx
		push edx
		pe.reloc 4, PE_DATAREF(aEnv), push relval	     ; "Environment Variables:\r\n"
		call PrintMsg
...
%ifdef DEBUG  ; Dump incoming syscall number.
		...
		push eax
		pe.reloc 4, PE_DATAREF(aUnsupportedInt+3), push relval
		call PrintMsg
...
%ifdef DEBUG  ; Indicate return from syscall.
		pushfd
		push eax
		pe.reloc 4, PE_DATAREF(aEnv), push relval
		call PrintMsg
...
loc_4109E0:
		...
		jne loc_4109E0
		pe.reloc 8, PE_BSSREF(force_last_error), mov dword [relval], ERR_TOO_MANY_OPEN_FILES
loc_4109FC:
		xor eax, eax
		jmp loc_410A2A
loc_410A00:
...
handle_INT21H_FUNC_4CH_EXIT_PROCESS:
		...
		jmp exit_pushed
		; Not reached.
handle_INT21H_FUNC_44H_IOCTL_IN_FILE:  ; jumptable 00410ED7 case 16
		xor eax, eax
		inc eax  ; EAX := 1 (ERR_INVALID_FUNCTION).
		cmp byte [esi], 0
...
handle_unsupported_int21h_function:  ; jumptable 00410ED7 case 0
		...
		push eax
		pe.reloc 4, PE_DATAREF(aUnsupportedInt), push relval
		call PrintMsg
		add esp, 8  ; Clean up stack from PrintMsg.
		jmp dos_error
